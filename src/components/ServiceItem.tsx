...
export const ServiceItem = ({
	...
	const containerClass = isFeature ? 'feature-content d-flex' : 'value-content d-flex-col';

	const detailClass = isFeature ? 'feature-detail' : 'value-detail';

	const titleClass = isFeature ? 'feature-detail-name' : 'value-title';

	const descriptionClass = isFeature ? 'feature-detail-paragraph' : 'value-paragraph';
